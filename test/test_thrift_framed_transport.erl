...
read_test_() ->
    [
        ...
        {"read zero bytes from nonempty framed membuffer",
            ?_assertMatch(
                {
                    {t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<0, 0, 0, 11, "hallo world">>}},
                        [], []},
                    {ok, <<>>}
                },
                read(
        ...
        {"read 1 byte from nonempty framed membuffer",
            ?_assertMatch(
                {
                    {t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<>>}}, <<"allo world">>, []},
                    {ok, <<"h">>}
                },
                read(
                    {t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<0, 0, 0, 11, "hallo world">>}},
        ...
        {"read 1 byte from nonempty buffer",
            ?_assertMatch(
                ...
                read(
                    {t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<>>}}, <<"hallo world">>, []},
                    1
                )
            )},
...
flush_test_() ->
    [
        {"flush empty framed membuffer",
            ?_assertMatch(
                {{t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<>>}}, [], []}, ok},
                flush({t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<>>}}, [], []})
            )},
        {"flush nonempty framed membuffer",
            ?_assertMatch(
                ...
                flush({t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<>>}}, [], <<"hallo world">>})
            )}
    ].
...
close_test_() ->
    {"close framed membuffer",
        ?_assertMatch(
            {{t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<>>}}, [], []}, {ok, <<>>}},
            close({t_framed, {t_transport, thrift_membuffer_transport, {t_membuffer, <<>>}}, [], []})
        )}.
