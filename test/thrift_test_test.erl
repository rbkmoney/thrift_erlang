...
struct_info_test_() ->
    [
                ...
                {struct, struct, [
                    ...
                    {3, required,
                        {list,
                            {map, {set, i32},
                                {map, i32,
                                    {set, {list, {map, {struct, struct, {'thrift_test_thrift', 'Insanity'}}, string}}}}}},
        ...
        {"LargeDeltas definition",
            ?_assertEqual(
                {struct, struct, [
                    ...
                    {2000, undefined, {struct, struct, {thrift_test_thrift, 'VersioningTestV2'}}, vertwo2000,
                        undefined},
                    {2500, undefined, {set, string}, a_set2500, undefined},
                    {3000, undefined, {struct, struct, {thrift_test_thrift, 'VersioningTestV2'}}, vertwo3000,
                        undefined},
        ...
        {"NestedListsBonk definition",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {list, {list, {list, {struct, struct, {thrift_test_thrift, 'Bonk'}}}}}, bonk,
                        undefined}
                ]},
